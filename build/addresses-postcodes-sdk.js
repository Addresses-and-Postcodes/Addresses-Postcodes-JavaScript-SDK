(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["AddressesPostcodesSDK"] = factory();
	else
		root["AddressesPostcodesSDK"] = factory();
})(self, () => {
...
var transitionalDefaults = __webpack_require__(765);

var AxiosError = __webpack_require__(477);

var CanceledError = __webpack_require__(132);

var parseProtocol = __webpack_require__(392);
...
axios.CanceledError = __webpack_require__(132);
axios.CancelToken = __webpack_require__(510);
axios.isCancel = __webpack_require__(825);
axios.VERSION = (__webpack_require__(992).version);
axios.toFormData = __webpack_require__(11); // Expose AxiosError class

axios.AxiosError = __webpack_require__(477); // alias for CanceledError for backward compatibility
...
axios.spread = __webpack_require__(346); // Expose isAxiosError

axios.isAxiosError = __webpack_require__(276);
...
var defaults = {
  ...
  maxBodyLength: -1,
  env: {
    FormData: __webpack_require__(689)
  },
...
var VERSION = (__webpack_require__(992).version);
...
var bind = __webpack_require__(345); // utils is a library of generic helper functions non-specific to axios
